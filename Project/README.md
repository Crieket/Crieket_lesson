...
Разворачиваем CMS "WORDPRESS" кластер веб-приложений "www.kas.local.ru" c файловым сервером на базе NSF, база mysql c реплицировнием, балансировщик Round Robin.
